# Running List of 3D Products in the Builder
...
- **Bose L1** — Bose — speakers — 3D model: ✓
- **CDJ-3000** — Pioneer DJ — players — 3D model: ✓
- **DJM-900NXS2** — Pioneer DJ — mixers — 3D model: ✓
- **Laptop** — Apple — device — 3D model: ✓
- **Pioneer DDJ-400** — Pioneer DJ — players — 3D model: ✓
- **Rane MP2015** — Rane — mixers — 3D model: ✓
- **Revolo** — TEILE — effects — 3D model: ✓
...
1. Add/edit/remove products via the in-app Product Management screen (Firestore is the source of truth).
2. Run `npm run dump-products` to regenerate this file.
3. Commit the updated `PRODUCTS.md`.
